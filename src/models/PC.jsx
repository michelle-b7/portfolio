...
export function PC(props) {
  ...
  const [instaTex, githubTex, linkedinTex, resumeTex] = useTexture([instaPixel, githubPixel, linkedinPixel, resumePixel])
            ...
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              <group name="pasokon_1">
                ...
                >
                    ...
                    {/* github */}
                    <Decal 
                    position={[1, 1.62, -.85]} // Positive X (0.9) to put it on the opposite side
